...
static struct can_message emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_0;

static uint32_t emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_count;
...
static void handler_run_tx_complete_thread_signal_CAN1_TX_IRQHandler(const bool *n_var0);
...
{
    uint32_t n_deref0 = emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_count;
    
    if ((bool) (n_deref0 <= 0)) {
        emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_count = (uint32_t) (n_deref0 + (uint32_t) 1U);
        emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_0 = *n_var0;
    }
}
...
void handler_run_tx_complete_thread_signal_CAN1_TX_IRQHandler(const bool *n_var0)
{
    /* init emitters */
    emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_count = (uint32_t) 0U;
    /* take monitor lock */
    monitor_lock_simplecontroller();
    /* run callbacks */
    callback_tx_complete_thread_signal_CAN1_TX_IRQHandler(n_var0);
    ...
    if ((bool) (0 < n_deref0)) {
        handler_run_request_thread_signal_CAN1_TX_IRQHandler(&emitter_tx_complete_chan_2_thread_signal_CAN1_TX_IRQHandler_message_0);
    }
}
...
void handler_run_tx_irq_thread_signal_CAN1_TX_IRQHandler(const int64_t *n_var0)
{
    ...
    if ((bool) (0 < n_deref0)) {
        handler_run_tx_complete_thread_signal_CAN1_TX_IRQHandler(&emitter_tx_irq_chan_3_thread_signal_CAN1_TX_IRQHandler_message_0);
    }
}
