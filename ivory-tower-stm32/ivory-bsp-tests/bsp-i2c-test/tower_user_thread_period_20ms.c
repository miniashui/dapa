...
static void emitter_i2c1_watchdog_chan_2(const struct i2c_transaction_result *n_var0);
...
void emitter_i2c1_watchdog_chan_2(const struct i2c_transaction_result *n_var0)
{
    emitter_i2c1_watchdog_chan_2_thread_period_20ms_emit(n_var0);
}
