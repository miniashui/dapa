...
static void emitter_i2c1_error_irq_chan_2(const struct i2c_transaction_result *n_var0);
...
void emitter_i2c1_error_irq_chan_2(const struct i2c_transaction_result *n_var0)
{
    emitter_i2c1_error_irq_chan_2_thread_signal_I2C1_ER_IRQHandler_emit(n_var0);
}
