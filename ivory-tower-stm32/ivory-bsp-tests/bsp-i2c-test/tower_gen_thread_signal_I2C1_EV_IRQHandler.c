...
static struct i2c_transaction_result emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_0;

static uint32_t emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_count;

struct binary_semaphore signal_semaphore_thread_signal_I2C1_EV_IRQHandler;

static void handler_run_result_thread_signal_I2C1_EV_IRQHandler(const struct i2c_transaction_result *n_var0);
...
void emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_emit(const struct i2c_transaction_result *n_var0)
{
    uint32_t n_deref0 = emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_count;
    
    if ((bool) (n_deref0 <= 0)) {
        emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_count = (uint32_t) (n_deref0 + (uint32_t) 1U);
        emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_0 = *n_var0;
    }
}

void handler_run_result_thread_signal_I2C1_EV_IRQHandler(const struct i2c_transaction_result *n_var0)
{
    /* init emitters */
    /* take monitor lock */
    monitor_lock_simplecontroller();
    /* run callbacks */
    callback_result_thread_signal_I2C1_EV_IRQHandler(n_var0);
...
{
    /* init emitters */
    emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_count = (uint32_t) 0U;
    /* take monitor lock */
    ...
    if ((bool) (0 < n_deref0)) {
        handler_run_result_thread_signal_I2C1_EV_IRQHandler(&emitter_i2c1_event_irq_chan_2_thread_signal_I2C1_EV_IRQHandler_message_0);
    }
}
