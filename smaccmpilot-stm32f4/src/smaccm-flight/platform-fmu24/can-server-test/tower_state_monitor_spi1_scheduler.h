 ...
 */
#ifndef __TOWER_STATE_MONITOR_SPI1_SCHEDULER_H__
#define __TOWER_STATE_MONITOR_SPI1_SCHEDULER_H__
#ifdef __cplusplus
extern "C" {
#endif
#include "ivory.h"
...
extern uint32_t spi1_scheduler_response_task;
extern bool spi1_scheduler_mpu6000_pending;
extern struct spi_transaction_request spi1_scheduler_mpu6000_last_req;
extern bool spi1_scheduler_lsm303d_pending;
extern struct spi_transaction_request spi1_scheduler_lsm303d_last_req;
extern bool spi1_scheduler_ms5611_pending;
extern struct spi_transaction_request spi1_scheduler_ms5611_last_req;
extern bool spi1_scheduler_l3gd20_pending;
extern struct spi_transaction_request spi1_scheduler_l3gd20_last_req;

#ifdef __cplusplus
}
#endif
#endif /* __TOWER_STATE_MONITOR_SPI1_SCHEDULER_H__ */
