 ...
 */
#ifndef __TOWER_STATE_MONITOR_L3GD20CTL_H__
#define __TOWER_STATE_MONITOR_L3GD20CTL_H__
#ifdef __cplusplus
extern "C" {
#endif
#include "ivory.h"
...
typedef struct l3gd20_continuation {
            uint32_t state;
            ...
            struct spi_transaction_request local26;
            struct spi_transaction_result r28;
            struct spi_transaction_request local29;
            struct spi_transaction_result r31;
            int64_t r32;
            int64_t local33;
            struct spi_transaction_request local0;
            struct spi_transaction_result r2;
            uint8_t deref3;
            struct spi_transaction_request local4;
            struct spi_transaction_result r6;
            struct spi_transaction_request local7;
            struct spi_transaction_result r9;
            uint8_t deref10;
            uint8_t deref11;
            bool local12;
        } l3gd20_continuation;
extern uint8_t l3gd20_retries;
extern bool l3gd20_panic;
extern struct spi_transaction_result last_value;
extern struct l3gd20_continuation l3gd20_cont;

#ifdef __cplusplus
}
#endif
#endif /* __TOWER_STATE_MONITOR_L3GD20CTL_H__ */
