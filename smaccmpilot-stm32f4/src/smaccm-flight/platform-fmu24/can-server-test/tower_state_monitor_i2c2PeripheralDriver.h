 ...
 */
#ifndef __TOWER_STATE_MONITOR_I2C2PERIPHERALDRIVER_H__
#define __TOWER_STATE_MONITOR_I2C2PERIPHERALDRIVER_H__
#ifdef __cplusplus
extern "C" {
#endif
#include "ivory.h"
...
extern uint8_t i2c2_driverstate;
extern bool i2c2_ready_sent;
extern struct i2c_transaction_request i2c2_reqbuffer;
extern int32_t i2c2_reqbufferpos;
extern struct i2c_transaction_result i2c2_resbuffer;
extern int32_t i2c2_resbufferpos;
extern uint32_t i2c2_invalid_request;
extern uint32_t i2c2_error_run;
extern int64_t i2c2_last_event;

#ifdef __cplusplus
}
#endif
#endif /* __TOWER_STATE_MONITOR_I2C2PERIPHERALDRIVER_H__ */
