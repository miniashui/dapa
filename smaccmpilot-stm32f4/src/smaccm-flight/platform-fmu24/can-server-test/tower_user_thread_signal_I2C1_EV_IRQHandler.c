 ...
 */
#include "tower_user_thread_signal_I2C1_EV_IRQHandler.h"

static void emitter_i2c1_event_irq_chan_180(const struct i2c_transaction_result *n_var0);

void callback_i2c1_schedulerasync_response_thread_signal_I2C1_EV_IRQHandler(const struct i2c_transaction_result *n_var0)
{
        ...
        if ((bool) (0 != (uint8_t) (uint16_t) ((uint16_t) (n_r2 >> 0) & (uint16_t) 1U))) {
            ...
            if ((bool) (0 != (uint8_t) (uint16_t) ((uint16_t) (n_r2 >> (uint16_t) 1U) & (uint16_t) 1U))) {
                ...
                if ((bool) (0 != n_deref10)) {
                    ...
                    emitter_i2c1_event_irq_chan_180(&i2c1_resbuffer);
                }
            }
        }
    } else {
...
void emitter_i2c1_event_irq_chan_180(const struct i2c_transaction_result *n_var0)
{
    emitter_i2c1_event_irq_chan_180_thread_signal_I2C1_EV_IRQHandler_emit(n_var0);
}
