 ...
 */
#ifndef __TOWER_GEN_THREAD_PERIOD_33MS_H__
#define __TOWER_GEN_THREAD_PERIOD_33MS_H__
#ifdef __cplusplus
extern "C" {
#endif
#include "ivory.h"
...
void loop_thread_period_33ms(struct taskarg *n_var0);
void emitter_rx_flush_chan_150_thread_period_33ms_emit(const struct ivory_string_GPSString *n_var0);
void emitter_write_gps_output_attr_chan_37_thread_period_33ms_emit(const struct position_sample *n_var0);
void emitter_ublox_istream_chan_147_thread_period_33ms_emit(const struct position_sample *n_var0);
void emitter_uart4_buf_rx_chan_152_thread_period_33ms_emit(const uint8_t *n_var0);

#ifdef __cplusplus
}
#endif
#endif /* __TOWER_GEN_THREAD_PERIOD_33MS_H__ */
