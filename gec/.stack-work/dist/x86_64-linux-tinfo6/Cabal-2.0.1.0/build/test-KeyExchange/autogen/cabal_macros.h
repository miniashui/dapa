...
/* package entropy-0.3.8 */
#ifndef VERSION_entropy
#define VERSION_entropy "0.3.8"
...
/* package curve25519-0.2.4 */
#ifndef VERSION_curve25519
#define VERSION_curve25519 "0.2.4"
...
/* package ed25519-donna-0.1.1 */
#ifndef VERSION_ed25519_donna
#define VERSION_ed25519_donna "0.1.1"
#endif /* VERSION_ed25519_donna */
#ifndef MIN_VERSION_ed25519_donna
#define MIN_VERSION_ed25519_donna(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 1)
#endif /* MIN_VERSION_ed25519_donna */
...
/* package monadcryptorandom-0.7.2.1 */
#ifndef VERSION_monadcryptorandom
#define VERSION_monadcryptorandom "0.7.2.1"
#endif /* VERSION_monadcryptorandom */
#ifndef MIN_VERSION_monadcryptorandom
#define MIN_VERSION_monadcryptorandom(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  7 || \
  (major1) == 0 && (major2) == 7 && (minor) <= 2)
#endif /* MIN_VERSION_monadcryptorandom */
...
#define CURRENT_COMPONENT_ID "gec-0.1-4MaMyShM7bSFrehyPm2FiA-test-KeyExchange"
